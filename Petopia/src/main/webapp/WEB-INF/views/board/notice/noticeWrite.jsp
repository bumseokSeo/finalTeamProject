...
<h1>공지사항 작성</h1>
<hr/>
	<form method="post" action="/board/notice/noticeWriteOk" id="noticeFrm" enctype="multipart/form-data">
  	  	<ul>
			<li><input type="hidden" name="boardtype" value="공지사항"/></li> <!--  게시판 타입num 넣어서 게시글 분류-->
			<li><input type="text" name="title" id="title" class="input01" placeholder="제목을 입력해주세요"/></li>
			<li><textarea id="ckeditor1"></textarea> </li>
